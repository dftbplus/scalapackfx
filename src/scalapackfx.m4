...
!!
!! \param aa  Cholesky decomposed matrix A on entry, inverse on exit.
!! \param desca  Descriptor of A.
!! \param uplo   Specifies whether lower ("L") or upper ("U") part of A
!!     contains the matrix. Default: "L".
!! \param ia  First row of the submatrix of A. Default: 1
!! \param ja  First column of the submatrix of A. Default: 1
!! \param nn  Number of rows and columns in the submatrix of A. Default: 
!!     desca(M_).
!! \param info  Info flag. If not specified and error occurs, the subroutine
!!     stops.
!!
!! \see SCALAPACK documentation (routine p?potri).
!!
...
!! \param aa  Cholesky decomposed matrix A on entry, inverse on exit.
!! \param desca  Descriptor of A.
!! \param uplo  Specifies whether lower ("L") or upper ("U") part of A contains
!!     the matrix. Default: "L".
!! \param diag  Specifies whether A is unit triangular ("U") or not ("N").
!!     Default: "N".
!! \param ia  First row of the submatrix of A. Default: 1.
!! \param ja  First column of the submatrix of A. Default: 1.
!! \param nn  Number of rows and columns in the submatrix of A.
!!     Default: desca(M_).
!! \param info  Info flag. If not specified and error occurs, the subroutine
!!     stops.
!!
!! \see SCALAPACK documentation (routine p?trtri).
!!
